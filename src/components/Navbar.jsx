        ...
        <div className="mt-2 sm:mt-0 sm:flex md:order-2 items-center gap-5">
          <div class="  flex justify-center items-center">
            <div class="relative py-2 ">
              <div class="t-0 absolute left-3 -mt-4">
                <p class="flex h-2 w-2 items-center justify-center rounded-full bg-red-500 p-3 text-xs text-white">{cartShopping.length} </p>
              </div>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
